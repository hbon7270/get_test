	...
	<div class="profileContainer">
		...
		<div class="profile-right">
			<div class="name-group">
				<h2>${dto.user.name}</h2>
		<!-- UserProfileDto -->
	<!-- UserService에서 dto로 받고--> 
	<!-- UserController dto를 통해 준다. -->
				<c:choose>
			...
			<div class="subscribe">
				<ul>
					...
					<li><a href="javascript:subscribeInfoModalOpen(${dto.user.id});"> 구독정보
					<span>${dto.subscribeCount}</span>
					</a></li>
				</ul>
			</div>
			<div class="state">
	...
	<div class="profileContainer">
		...
		<div id="tab-1-content" class="tab-content-item show">
			...
			<div class="tab-1-content-inner">
				...
				<c:forEach var="image" items="${dto.user.images }"> <!-- EL 표현식에서 변수명을 적으면 get 함수가 자동 호출된다. -->
					<div class="img-box">
